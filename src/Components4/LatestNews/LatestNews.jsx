      ...
      <div className="Container">
        ...
        <div className="mt-14">
          <div className="grid grid-cols-6 2xl:grid-rows-4 2xl:grid-flow-col  gap-6">
            {/* card - 1 */}
            <div className=" bg-white dark:bg-lightBlack  h-full col-span-6 sm:col-span-3 2xl:row-span-4 2xl:col-start-1 2xl:col-end-4">
              <img className="" src="/images/home-4/blog-1.jpg" alt="" />
              <div className="px-3 md:px-7 py-5 md:py-[30px] ">
                <div className="pb-3 flex items-center justify-start ">
                  <div className="flex items-center">
                    <span className="w-7 h-7 md:w-9 md:h-9  dark:bg-normalBlack grid items-center justify-center">
                ...
                <Link to="#">
                  <h5 className="text-[22px] 2xl:text-3xl mt-3 leading-6 md:leading-7 2xl:leading-[38px] text-lightBlack dark:text-white font-medium font-Garamond">
            ...
            <div className=" flex flex-col items-center  2xl:flex-row  bg-white dark:bg-lightBlack col-span-6 sm:col-span-3 2xl:row-span-2 2xl:col-start-4 2xl:col-end-7">
              <img
                className="object-cover w-full h-[200px] sm:h-[174px] md:h-[234px] lg:h-[316px] xl:h-[375px] 2xl:h-[358px] md:rounded-none "
                src="/images/home-4/blog-2.jpg"
                alt=""
              />
              <div className="flex flex-col justify-between px-3 md:px-7 py-5 md:py-[30px] 2xl:py-2 ">
                <div className="pb-3 flex items-center justify-start ">
                  <div className="flex items-center">
                    <span className="w-7 h-7 md:w-9 md:h-9  dark:bg-normalBlack grid items-center justify-center">
                      <FiUser size={16} className="text-khaki " />
