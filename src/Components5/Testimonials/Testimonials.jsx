  ...
  return (
    <section className="bg-normalBlack py-20 2xl:py-[120px]">
      ...
      <div className="text-center mx-auto px-5 sm:px-8 md:px-[80px] lg:px-[120px] xl:px-[200px] 2xl:px-[335px] Container">
        ...
        <h2
          className="text-white text-3xl md:text-4xl xl:text-[38px] leading-7 md:leading-9 lg:leading-10 2xl:leading-[43px]
      ...
      <div className="relative Container">
        <div className="mt-14 2xl:mt-[60px] keen-slider " ref={sliderRef}>
          ...
          <div className="keen-slider__slide number-slide1 ">
            ...
            <div className="bg-lightBlack py-[35px] px-[32px] text-center">
              ...
              <p className="font-Lora text-sm leading-[23px] text-lightGray font-normal mt-7 ">
                ...
                Peaceful Private Retreat in TheIn Heart of One of The World Most
                Iconic Provvide Professgional Services Apartment experienced che
                international specialties with
              </p>
            </div>
          </div>
          {/* slide - 2 */}
