              ...
              <div className="font-Garamond border border-[#ddd]">
                <div className="py-6 px-[30px] ">
                  <div className="flex items-center space-x-6">
                    <p className="text-base leading-[26px] text-gray font-normal uppercase mr-7 ml-3 relative before:absolute before:w-[7px] before:h-[7px] before:left-[-13px] before:bg-[#d1d1d1] before:top-[9px]">
                      August 10, 2023
                    </p>
                    <p className="text-base leading-[26px] text-gray font-normal uppercase mr-7 ml-3 relative before:absolute before:w-[7px] before:h-[7px] before:left-[-13px] before:bg-[#d1d1d1] before:top-[9px]">
                      Interior
                  ...
                  <Link to="#">
                    <h2 className="text-[26px] leading-[34px] font-semibold text-lightBlack py-4 group-hover:underline underline-offset-2">
