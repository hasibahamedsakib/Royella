    ...
    <section className="Container py-[120px] md:py-0 md:pb-[120px] lg:py-[120px]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 px-3 sm:px-5">
        <div className="space-y-3 lg:space-y-5  md:w-[450px] font-Garamond">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl 2xl:text-[38px] leading-[38px] lg:leading-[44px]  text-lightBlack font-semibold">
      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          ...
          <div className="relative font-Garamond md:ml-[60px] lg:ml-[107px] mt-3 md:mt-0  h-full">
            ...
            <h1 className="text-2xl md:text-3xl 2xl:text-[32px] leading-[26px] font-semibold text-lightBlack">
              Gym Training Grounds
            </h1>

            <p className="font-Lora text-sm sm:text-base text-gray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px] relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          <div className=" font-Garamond md:mr-[2px] lg:mr-[110px]  h-full">
            ...
            <p className="font-Lora relative text-sm sm:text-base text-gray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
              Rapidiously myocardinate cross-platform intellectual capital after
              model. Appropriately create interactive infrastructures after are
              Holisticly facilitate stand-alone
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          ...
          <div className=" font-Garamond md:ml-[60px] lg:ml-[107px] mt-3 md:mt-0 relative h-full">
            ...
            <p className="font-Lora text-sm sm:text-base text-gray leading-[26px] font-normal my-10 lg:mt-[46px] lg:mb-[40px] relative before:absolute before:h-[30px] before:left-0 before:top-[-35px] before:bg-[#ddd] before:w-[1px]">
              Rapidiously myocardinate cross-platform intellectual capital after
              model. Appropriately create interactive infrastructures after are
              Holisticly facilitate stand-alone
            </p>
