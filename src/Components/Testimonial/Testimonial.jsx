...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url('/images/home-1/testi-bg.jpg')] bg-[rgba(30,30,30,0.4)] dark:bg-[rgba(30,30,30,0.6)] bg-opacity-40 grid items-center justify-center">
      <div className="Container py-20 lg:py-[120px]">
        ...
        <div className="text-center sm:px-8 md:px-[80px] lg:px-[120px] xl:px-[200px]  2xl:px-[335px] mx-auto px-5">
          ...
          />
          <h1 className="text-xl sm:text-2xl md:text-3xl 2xl:text-[38px] leading-[42px] 2xl:leading-[52px] text-white mt-[30px] mb-[24px] font-Garamond font-semibold uppercase">
            ...
            <SwiperSlide>
              <div className="py-[10px] pt-10 ">
                <div className="bg-white dark:bg-normalBlack p-10 relative before:absolute before:w-[85%] before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 ">
                  ...
                  <p className="font-Lora leading-[26px] text-gray dark:text-lightGray font-normal text-lg mt-[30px] italic mb-[45px] before:absolute before:h-[30px] before:left-0 before:bottom-[-36px] before:bg-khaki before:w-[1px] relative">
